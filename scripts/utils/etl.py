...
class EtlExecutor:
    ...
    def transfer_table(self, source_table: str, target_table: str, columns: List[Tuple[str, str]], **kwargs):
        ...
        Args:
            ...
            columns: упорядоченный список пар названий колонок целевой таблицы и их типов
                    [(имя, тип), ...]
            kwargs: предопределённые значения колонок (остальные значения колонок берутся из таблицы источника)
        """
